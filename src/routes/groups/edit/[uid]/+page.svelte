<script lang="ts">
    ...
    import {Code, Group} from "$lib/groups";
...
{:else if $group}
    <div class="w-full h-full pt-16">
        ...
        <div class="w-full h-full max-w-4xl xl:max-w-6xl p-5 pt-10 m-auto">
            ...
            <input id="title-input" class="text-4xl input mb-2" bind:value={$group.title} placeholder="Title">
            <input id="description-input" class="input" bind:value={$group.description} placeholder="Description">
