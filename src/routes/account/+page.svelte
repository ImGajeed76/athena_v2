...
{#if $currentUser}
    <div class="w-full h-full pt-16">
        ...
        <div class="w-full h-full grid lg:grid-cols-[auto_1fr]">
            <div class="w-full h-fit lg:pl-2 lg:pb-5 scale-90 lg:scale-100 lg:fixed pt-7">
                ...
                <div class="w-full h-full lg:overflow-y-auto scale-90 lg:scale-100">
                    ...
                    <div class="mb-7">
                        ...
                        <p class="max-w-[80%]">Turn this on to help us refine our suggestions for everyone. Your card
                            details will be used anonymously to improve the quality of card suggestions. Your
                            contribution
