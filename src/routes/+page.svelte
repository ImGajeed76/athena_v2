            ...
            <div class="lg:mr-32 lg:h-[26rem] h-[28rem] grid items-center text-white">
                <div class="lg:p-5 h-full w-full flex flex-col justify-between">
                    {#if $athenaArgument === 0}
                        <div in:fly={{ duration: 300 }}>
                            ...
                            <p class="text-xl">
                                ...
                                a right, not a privilege. That's why Athena is completely free, ensuring everyone has access
                    ...
                    {:else if $athenaArgument === 1}
                        <div in:fly={{ duration: 300 }}>
                            ...
                            <p class="text-xl">
                                ...
                                With features like quiz modes, interactive slides, and collaborative classes, Athena makes learning engaging and effective.
                            </p>
                        </div>
                    {:else if $athenaArgument === 2}
                        <div in:fly={{ duration: 300 }}>
                            ...
                            <p class="text-xl">
                                ...
                                Athena's clean and simple design ensures a seamless user experience, making learning and teaching straightforward and enjoyable.
                            </p>
                            <p class="text-xl mt-3">
                                <span class="font-bold">Community Driven:</span>
                                Built with feedback from educators and learners, Athena is continuously evolving to meet the real needs of its users.
                            </p>
                        </div>
                    {:else if $athenaArgument === 3}
                        <div in:fly={{ duration: 300 }}>
                            ...
                            <p class="text-xl">
                                ...
                                Whether you're a student seeking knowledge or a teacher shaping minds, Athena is your companion in the journey of education.
                            </p>
                        </div>
                    {:else if $athenaArgument === 4}
                        <div in:fly={{ duration: 300 }}>
                            ...
                            <p class="text-xl">
                                ...
                                We're constantly improving and expanding Athena's capabilities, staying ahead in the ever-changing landscape of educational technology.
                            </p>
                            <p class="text-xl mt-3">
                    ...
                    <div class="w-full flex-row flex justify-between mt-5 items-center">
                        <button class="btn rounded-full hover:variant-ghost w-10 h-10 p-2 duration-200" on:click={previousArgument}>
