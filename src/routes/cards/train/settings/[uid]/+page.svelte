<script lang="ts">
    ...
    import {getModalStore, ProgressRadial, SlideToggle} from "@skeletonlabs/skeleton";
    ...
    function resetProgress() {
        modalStore.trigger({
            ...
            body: "Are you sure you want to reset your progress? This will reset your progress for this set and you will have to start over.",
...
{:else if $set}
    <div class="w-full h-full pt-16">
        ...
        <div class="w-full h-full max-w-4xl xl:max-w-6xl p-5 pt-10 m-auto">
            ...
            <div class="w-full flex justify-around mt-20">
                <button class="btn variant-ghost-error hover:variant-filled-error" on:click={resetProgress}>
                    Reset Progress
                </button>
            </div>
        </div>
